...
class mnist(nn.Module):
    ...
    def forward(self, x):
        ...
        h_fc1_drop = self.drop(h_fc1)
        y_conv = self.fc2(h_fc1_drop)
        if test:
            write_file('input', x)
            write_file('h_conv1', h_conv1)
            write_file('h_conv1_relu', h_conv1_relu)
            write_file('h_pool1', h_pool1)
            write_file('h_conv2', h_conv2)
            write_file('h_conv2_relu', h_conv2_relu)
            write_file('h_pool2', h_pool2)
            write_file('h_pool2_flat', h_pool2_flat)
            write_file('h_fc1', h_fc1)
            write_file('h_fc1_relu', h_fc1_relu)
            write_file('h_fc1_drop', h_fc1_drop)
            write_file('y_conv', y_conv)
