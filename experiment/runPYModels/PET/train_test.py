...
test_data = PETDataset('/root/hostStorage/ML_FPGA_compton_PET/image_compton_small_module_1mm_pitch', transform=transformation,
                      test=True, test_percentage=0.3)
test_loader = torch.utils.data.DataLoader(test_data, batch_size=BATCHSIZE, shuffle=False)
train_data = PETDataset('/root/hostStorage/ML_FPGA_compton_PET/image_compton_small_module_1mm_pitch', transform=transformation,
                       test=False, test_percentage=0.3)
